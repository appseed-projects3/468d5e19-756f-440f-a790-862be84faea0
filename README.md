...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-13 13:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/468d5e19-756f-440f-a790-862be84faea0.git
$ cd 468d5e19-756f-440f-a790-862be84faea0
```
